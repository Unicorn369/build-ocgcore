...
ifeq ($(config),release)
  ...
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -O3 -x c++ -fPIC $(OSX_CFLAGS)
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -O3 -x c++ -fPIC $(OSX_CFLAGS)
...
ifeq ($(config),debug)
  ...
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -g -x c++ -fPIC $(OSX_CFLAGS)
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -g -x c++ -fPIC $(OSX_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS)
